...
<!-- <div class="min-h-screen flex justify-center items-center">
  <div class="max-w-md mx-auto">
    <div class="bg-white shadow-lg rounded-lg p-4">
      <h2 class="text-2xl mb-2 text-center">{message}</h2>
      <div class="flex justify-center mt-3 space-x-2">
        ...
        <div class="w-1/2">
          <input
            bind:value={title}
            class="rounded-md border border-gray-300 px-3 py-2 w-full placeholder-italic placeholder-gray-400 text-lg text-center"
            type="text"
            placeholder="Not"
          />
        </div>
